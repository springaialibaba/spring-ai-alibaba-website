...
export const PopupContent = ({ image, title, labels, links, direction = 'top' }) => {
      ...
      <div className="flex items-center justify-between border-b border-gray mb-4 pb-4">
        ...
        <div >
          {labels.map((label, idx) => (
            <span
              key={idx}
              className="bg-[#e6f4ff] bg-opacity-60 border border-[#91caff] text-[#1677ff] text-xs px-2 py-1 rounded mr-2 mb-2 whitespace-nowrap"
            >
              {label}
            </span>
          ))}
          ...
          (
            ...
            <div key={idx} className="mb-2 flex justify-between">
              ...
              <div className="w-[70%] overflow-hidden ">
                <a href={link} className={twMerge("line-clamp-1 no-underline", linkClassname)}>
                  {link}
                </a>
